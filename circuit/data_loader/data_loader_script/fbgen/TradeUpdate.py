...
def TradeUpdateStart(builder): builder.StartObject(1)
def Start(builder):
    return TradeUpdateStart(builder)
def TradeUpdateAddTrades(builder, trades): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(trades), 0)
def AddTrades(builder, trades):
    return TradeUpdateAddTrades(builder, trades)
def TradeUpdateStartTradesVector(builder, numElems): return builder.StartVector(32, numElems, 8)
