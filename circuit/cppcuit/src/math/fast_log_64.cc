...
static int precompute_log_tangents() {
  ...
  for (std::size_t i = 0; i < TANGENTS; i++) {
    ...
    //   This gives continuity at the edges, and ensures the result is zero at one
    // 2. Use many points to get a true best-fit line.
    //    This is more accurate but sacrifices continuity at the points and zero at one
    //
    // I go with one as accuracy is improved by a larger set of lines, and continuity
    // as well as zero-at-one is very valuable
